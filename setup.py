"""
This is the setup module for the action-apb-dashboard project.
...
setup(
    ...
    version=get_version("src/apb_dashboard/_version.py"),
    ...
    project_urls={
        "Source": "https://github.com/cisagov/action-apb-dashboard",
        "Tracker": "https://github.com/cisagov/action-apb-dashboard/issues",
    },
    # Author details
    ...
    install_requires=["chevron", "python-dateutil", "setuptools"],
    extras_require={
    ...
    # Conveniently allows one to run the CLI tool as `apb-dashboard`
    entry_points={"console_scripts": ["apb-dashboard = apb_dashboard.entrypoint:main"]},
)
